...
def main():
    ...
    repoUrl="https://github.com/{}/{}/security/dependabot".format(owner,repoName)
    pp.pprint(repoUrl)
    ...
    summaryText=f"There are currently {statsDict['total_alerts']} open security [vulnerabilities](https://github.com/{repo}/security/dependabot)."
